...
  >
    <!-- Tampilkan logo hanya jika ada -->
    <div class="w-8 h-8 rounded-full overflow-hidden bg-white flex items-center justify-center">
      <img v-if="conf.logo" :src="conf.logo" :alt="conf.prettyName || name" class="w-full h-full object-contain" />
      <Icon v-else icon="mdi:image-off" class="text-gray-400 text-xl" />
    </div>
